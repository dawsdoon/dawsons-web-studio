      ...
      <main id="top">
        <section className="mx-auto grid min-h-[86vh] max-w-7xl items-center gap-12 px-6 py-20 md:grid-cols-2 md:py-28">
          <motion.div initial={{ opacity: 0, y: 22 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.65 }}>
            ...
            <p className="mt-6 max-w-xl text-lg leading-8 text-slate-300">Landings from $350, redesigns from $600, full business sites at $1,000. I handle design, development, domain, and hosting through My Web Studio — plus optional care from $40/mo when you want updates handled for you.</p>
